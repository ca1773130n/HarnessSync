...
"""Tutorial content: TaskFlow project scaffolding, step file templates, and step guides.

This module contains all the static content for the /sync-tutorial command:
- scaffold_project(): creates the TaskFlow demo project
- add_step_files(): writes config files for each tutorial step
- get_step_guide(): returns the markdown guide text for each step
"""
