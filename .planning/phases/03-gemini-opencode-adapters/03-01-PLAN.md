...
<task type="auto">
  ...
  <verify>
    ...
    7. Verify idempotency: re-sync rules -> markers replaced, not duplicated
    8. Verify user content preservation: add content outside markers, re-sync, verify user content still present
