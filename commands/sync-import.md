---
description: Import configuration FROM a target harness (Codex, Cursor, Aider, etc.) INTO Claude Code format
---
...
Arguments:
- TARGET: Harness to import from (codex, cursor, aider, windsurf, opencode, ...)
...
Examples:
- /sync-import codex              — stage Codex config for review
...
- /sync-import codex --path ~/other-project  — import from a different directory
